...
1. Directly modify any files under **`pkg`** in this repo.
   Those are driven from **`k8s.io/kubernetes/staging/src/k8s.io/apiserver`**.

2. Expect compatibility.
   This repo is changing quickly in direct support of Kubernetes and the API isn't yet stable enough for API guarantees.
